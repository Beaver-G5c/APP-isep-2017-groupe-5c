...
$map->setAPIKey(' AIzaSyDhcQdyARYMP_w3hXK6pNCW6WR9HYpZgdQ ');
 //AIzaSyDhcQdyARYMP_w3hXK6pNCW6WR9HYpZgdQ 
...
<?php $map->addMarkerByAddress( "paris", "paris bulle", "voila le truc ", "Sens co Paris"); ?>
