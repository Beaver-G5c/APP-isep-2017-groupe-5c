...
if (isset($_POST['submit_add_user']))
	...
	if (!is_login_free($_POST['name']))
		...
		//check_install_number_is_free($bdd,$install_number,$id_user)
		/*$insta=input_securisation($_POST['insta']);
		$id_user_cible=get_id_from_name(input_securisation($_POST['name']));
		if (check_install_number_is_free($bdd,$insta,$id_user_cible)){
