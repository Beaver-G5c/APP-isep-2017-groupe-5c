...
require ($localisation.'admin/view/admin_alert_view.php');
	...
	if (isset($_POST['submit_add'])){
	    //$id_simple=get_next_id($bdd);
	    $id_notif=get_next_id($bdd);
	    add_alert($_POST['description'],$_POST['name'],$_POST['id_user_target'],$_POST['category'], $_POST['lvl_alert'],  $bdd,$id_notif);
	...
	if (isset($_POST['submit2'])){
		update_db_notification ($_POST['user_id'],$_POST['alert_id'],  $_POST['description'], $_POST['alert_state'], $_POST['alert_name'], $_POST['alert_lvl'], $_POST['category'],  $bdd );
		//addForm();
