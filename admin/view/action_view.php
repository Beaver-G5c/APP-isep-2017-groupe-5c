...
{
	echo ("L'utilisateur a ̩t̩ supprim̩");?>
...
function updateUserForm($donnees)
	...
	<form method="POST" action="<?php echo ($nomwamp."controller/action2.php") ; ?>">
			...
			<label> Num̩ro de t̩l̩phone :</label><input type="tel" id="phone_number" name="phone_number" value="<?php echo( $donnees['phone_number']);?>" />
