...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 25 jan. 2018 à 10:22
...
('salle de bain', 2, 4, 1, 103, NULL, NULL, 0),
...
('blabla', 2, 23, 1, 454, NULL, NULL, 0),
('bla', 2, 76, 11, 564, 1, 1, 1),
('nom', 2, 32, 1, 43, NULL, NULL, 0);
...
(18, 'Teva', 234, 234234, 'zefzf', 11),
(22, 'ver', 2342, 12, 'defzfz', 10);
...
(175, 'Comment puis je modifier mes informations personnelles?', 'Vous pouvez modifier vos informations personnelles depuis la page \"mon profil\".', ''),
...
(7, 5, 'hey', '2018-01-22 10:03:38', 'hey', 'Non traitee', 'hey', 5, 0),
